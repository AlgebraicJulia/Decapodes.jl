...
wsave(resultsdir(sim_name, "stats_$(task_key)_$(code_target_name).jld2"), stats_data)
...
BenchmarkTools.save(resultsdir(sim_name, "benchmarks_$(task_key)_$(code_target_name).json"), deca_sim_results)
