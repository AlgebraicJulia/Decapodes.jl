...
@testset "File names" begin
  @test "heat_cpu_test.toml" == config_name(SimNameData("heat", "cpu", "test"))
  ...
  @test "heat_cpu_default.toml" == config_name(SimNameData("heat", "cpu", "default"))
  @test "test_cuda_default.toml" == config_name(SimNameData("test", "cuda", "default"))
  
  expected_config_dir = joinpath("heat", config_name(SimNameData("heat", "cuda", "test")))
  @test occursin(expected_config_dir, config_path(SimNameData("heat", "cuda", "test")))
end
