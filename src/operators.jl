...
function add_Inter_Prod_1D!(::Val{1}, d::SummationDecapode, proj1_Inter::Int, proj2_Inter::Int, res_Inter::Int)
  add_Inter_Prod!(d, proj1_Inter, proj2_Inter, res_Inter)
end

function add_Inter_Prod_2D!(::Val{1}, d::SummationDecapode, proj1_Inter::Int, proj2_Inter::Int, res_Inter::Int)
...
function add_Inter_Prod_2D!(::Val{2}, d::SummationDecapode, proj1_Inter::Int, proj2_Inter::Int, res_Inter::Int)
  add_Inter_Prod!(d, proj1_Inter, proj2_Inter, res_Inter)
end

function add_Lie_1D!(::Val{0}, d::SummationDecapode, proj1_Lie::Int, proj2_Lie::Int, res_Lie::Int)
...
function add_Lie_1D!(::Val{1}, d::SummationDecapode, proj1_Lie::Int, proj2_Lie::Int, res_Lie::Int)
...
function add_Lie_2D!(::Val{0}, d::SummationDecapode, proj1_Lie::Int, proj2_Lie::Int, res_Lie::Int)
...
function add_Lie_2D!(::Val{1}, d::SummationDecapode, proj1_Lie::Int, proj2_Lie::Int, res_Lie::Int)
...
function add_Lie_2D!(::Val{2}, d::SummationDecapode, proj1_Lie::Int, proj2_Lie::Int, res_Lie::Int)
...
function add_De_Rham_1D!(::Val{0}, d::SummationDecapode, src_De_Rham::Int, tgt_De_Rham::Int)
  exterior_deriv = add_part!(d, :Var, type=:infer, name=nothing)
...
function add_De_Rham_1D!(::Val{1}, d::SummationDecapode, src_De_Rham::Int, tgt_De_Rham::Int)
...
function add_De_Rham_2D!(::Val{0}, d::SummationDecapode, src_De_Rham::Int, tgt_De_Rham::Int)
  add_De_Rham_1D!(Val(0), d, src_De_Rham, tgt_De_Rham)
end

function add_De_Rham_2D!(::Val{1}, d::SummationDecapode, src_De_Rham::Int, tgt_De_Rham::Int)
...
function add_De_Rham_2D!(::Val{2}, d::SummationDecapode, src_De_Rham::Int, tgt_De_Rham::Int)
